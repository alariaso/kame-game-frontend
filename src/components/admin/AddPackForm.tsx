...
const formSchema = z.object({
  ...
  cardCount: z.string().min(1, { message: "El número de cartas es requerido" }),
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-background border-gold/30 sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gold">Agregar Nuevo Paquete</DialogTitle>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" placeholder="Cantidad de cartas por paquete" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" placeholder="Precio en Yugi Pesos" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" placeholder="Unidades disponibles" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="URL de la imagen del paquete" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
