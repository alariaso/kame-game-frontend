	...
	const getWinnerDisplay = (winner: string | null) => {
		if (winner === "player") {
			return {
				...
				class: "bg-green-500/20 border-green-500/30",
			}
		} else if (winner === "ai") {
			return {
				icon: <X size={20} className="text-red-500" />,
				class: "bg-red-500/20 border-red-500/30",
			}
		} else {
			return {
				...
				<CardHeader>
					<div className="flex justify-between items-center mb-2">
						...
						<div className="flex items-center gap-6">
							<div className="flex items-center">
								<span className="text-gold font-bold text-lg mr-2">
									{roundsWon.player}
								</span>
							...
							<div className="flex items-center">
								...
								<span className="text-gold font-bold text-lg ml-2">
									{roundsWon.ai}
								</span>
							</div>
						</div>
					...
					<CardTitle className="text-2xl text-gold text-center">
						{showResult
							...
							: "Elige tu carta para esta ronda"}
					</CardTitle>
						...
						<div className="flex flex-col">
							...
							<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
								{playerDeck.cards.map((card, i) => {
									const isSelected =
										playerDeck.selectedCardIndex === i
							...
							<div className="mt-6 border-t border-gold/20 pt-6">
								<h3 className="text-lg font-medium mb-4 text-gold">
									Carta del rival para esta ronda:
								</h3>
								...
								<p className="text-center text-sm text-gray-400 mt-2">
									El rival ha elegido su carta pero permanece
									oculta hasta resolver la ronda.
								</p>
							</div>
						</div>
					)}
