    ...
    <header className="w-full py-4 px-6 bg-black/50 backdrop-blur-md border-b border-gold/10 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center gap-2">
          <span className="text-gold font-heading text-xl font-bold">Kame Game</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {isAuthenticated ? (
            ...
            <div className="flex gap-2">
              <Button asChild variant="ghost" className="hover:bg-gold/10 text-gray-300 hover:text-gold">
                <Link to="/login">
