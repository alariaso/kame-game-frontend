    ...
    <div className="min-h-[calc(100vh-73px)] flex flex-col">
      ...
      <section className="relative py-20 px-6 flex flex-col items-center justify-center bg-gradient-to-b from-mystic/70 to-background text-center">
        ...
        <div className="container max-w-4xl mx-auto relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 relative group">
            ...
            <span className="absolute inset-0 bg-gradient-to-r from-gold/20 to-gold-light/20 blur-xl opacity-50 
                          group-hover:opacity-70 transition-opacity duration-700 ease-in-out"></span>
          </h1>
          <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
            Bienvenido al mercado de cartas más místico y elegante. Encuentra las cartas más poderosas y arma tu mazo legendario.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isAuthenticated ? (
              <>
                <Button asChild size="lg" className="bg-gold hover:bg-gold-dark text-black font-semibold">
                  <Link to="/shop">
                    <ShoppingCart className="mr-2" size={20} />
                    Visitar Tienda
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-gold/20 hover:bg-gold/10 text-gold">
                  <Link to="/battles">
      ...
      <section className="py-16 px-6 bg-black/20">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center text-gold">Descubre el poder de las cartas</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-b from-black/40 to-black/60 p-6 rounded-lg border border-gold/10 transform transition-all hover:border-gold/30 card-hover">
              ...
              <h3 className="text-xl font-semibold mb-3 text-center">Amplia Colección</h3>
            ...
            <div className="bg-gradient-to-b from-black/40 to-black/60 p-6 rounded-lg border border-gold/10 transform transition-all hover:border-gold/30 card-hover">
              ...
              <h3 className="text-xl font-semibold mb-3 text-center">Gestión de Mazos</h3>
              <p className="text-gray-400 text-center">
            ...
            <div className="bg-gradient-to-b from-black/40 to-black/60 p-6 rounded-lg border border-gold/10 transform transition-all hover:border-gold/30 card-hover">
              ...
              <h3 className="text-xl font-semibold mb-3 text-center">Duelos Místicos</h3>
              <p className="text-gray-400 text-center">
